...
public class ClubAdapterTest {
    ...
    public void testGetShortName() throws Exception {
        MasterCurriculum curriculum = new MasterCurriculum("a name", null, Collections.emptyList(), null, false, null);
    ...
    public void testGetCurriculum() throws Exception {
        MasterCurriculum curriculum = new MasterCurriculum(null, null, Collections.emptyList(), null, false, null);
        Club classUnderTest = DomainTestUtil.createClubAdapter(null, curriculum);
